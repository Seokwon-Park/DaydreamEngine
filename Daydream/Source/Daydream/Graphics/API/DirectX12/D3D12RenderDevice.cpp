...
namespace Daydream
{
	...
	Shared<Framebuffer> Daydream::D3D12RenderDevice::CreateFramebuffer(Shared<RenderPass> _renderPass, const FramebufferDesc& _desc)
	{
		return _renderPass->CreateFramebuffer(_desc);
	}

	Shared<PipelineState> Daydream::D3D12RenderDevice::CreatePipelineState(const PipelineStateDesc& _desc)
	{
