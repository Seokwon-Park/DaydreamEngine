...
{
	void DrawDragFloat(const String& _label, Float32& _value, Float32 _speed = 0.1f, Float32 _minValue = 0.0f, Float32 _maxValue = 0.0f, Float32 _resetValue = 0.0f, Float32 _columnWidth = 100.0f);
