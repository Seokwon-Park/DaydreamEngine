...
namespace Daydream
{
	void Texture2DRegistry::CreateEssentialTextures()
	{
		TextureDesc desc{};
	...
	void Texture2DRegistry::LoadTexturesFromDirectory(Path _directory, bool _isRecursive)
	{
