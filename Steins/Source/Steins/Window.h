...
#define STEINS_KEY_RELEASE 0
#define STEINS_KEY_PRESS 1
#define STEINS_KEY_REPEAT 2
...
namespace Steins
{
	...
	public:
		...
		void SetKeyCallback(std::function<void(SteinsWindow*, int, int)> _inputKeyFn) { callbacks.inputKeyFn = _inputKeyFn; }
